...
<template>
  <div class="cabinet-toolbar">
    <a-space>
      <Dropdown v-if="canManage" :trigger="['click']" :drop-menu-list="createMenuList"
        @menu-event="handleCreateMenuEvent">
      ...
      <div v-if="canManage" ref="uploadWrapRef" class="cabinet-toolbar-upload-wrap">
        <input ref="fileUploadInputRef" class="cabinet-file-input" type="file" multiple
          @change="handleFileInputChange" />
        <input ref="folderUploadInputRef" class="cabinet-folder-input" type="file" multiple webkitdirectory
      ...
      <a-input-search :value="searchKeyword" allow-clear class="toolbar-search" placeholder="搜索当前目录文件/文件夹"
        @update:value="emit('update:searchKeyword', $event)" @search="emit('search')" />
